            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="about-us-content mb-100">
                        ...
                        <img src="{{asset('site/img/core-img/signature.png')}}" alt="" class="wow fadeInUp" data-wow-delay="500ms">
                    </div>
                </div>
                        ...
                        <div class="row no-gutters">
                            <div class="col-6">
                                <div class="single-thumb">
                                    <img src="{{asset('site/img/bg-img/13.jpg')}}" alt="">
                                </div>
                                <div class="single-thumb">
                                    <img src="{{asset('site/img/bg-img/14.jpg')}}" alt="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="single-thumb">
                                    <img src="{{asset('site/img/bg-img/15.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
